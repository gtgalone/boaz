...
class Nav extends React.Component<Props> {
  public render() {
    return (
      <nav className="flex items-center absolute w-100 pa3">
        <a className="flex flex-column white-80 w2" href="#">
        ...
        <ul className="list pl0 flex flex-grow-1 justify-around white avenir f6 fw5">
          <li>
            <a href="#" className="nav link white-80 relative">Home</a>
          </li>
          <li>
            <a href="#" className="nav link white-80 relative">What We Do</a>
          </li>
          <li>
            <a href="#" className="nav link white-80 relative">Our Story</a>
          </li>
          <li>
            <a href="#" className="nav link white-80 relative">Journal</a>
          </li>
          <li>
            <a href="#" className="nav link white-80 relative">Contact</a>
          </li>
        </ul>
        <style jsx>{`
          nav {
