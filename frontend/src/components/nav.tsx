...
class Nav extends React.Component<Props, State> {
  ...
  public render() {
    ...
    return (
      <nav className="flex items-center justify-between absolute w-100 pa3">
        ...
        <ul className={classNames('navigator-mobile absolute top-0 left-0 w-100 vh-100 ma0 pa0 bg-gold', { 'active-navigator-mobile': isOpenMenu })}></ul>
        <style jsx>{`
          nav {
            letter-spacing: .1em;
